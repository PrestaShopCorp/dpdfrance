	...
	<div id="div_dpdfrance_predict_gsm">
		<form method='post' action='{if $ssl}{$base_dir_ssl|escape:'htmlall':'UTF-8'}{else}{$base_dir|escape:'htmlall':'UTF-8'}{/if}modules/dpdfrance/validation.php?dpdfrance_carrier={$dpdfrance_predict_carrier_id|escape:'javascript':'UTF-8'}'>
			<p>
				...
				<input type='text' name="dpdfrance_predict_gsm_dest" id="input_dpdfrance_predict_gsm_dest" value="{$dpdfrance_predict_gsm_dest|escape:'htmlall':'UTF-8'}"></input>{if $dpdfrance_predict_status != 'ok'}<input type="submit" value="{$dpdfrance_predict_gsm_dest|escape:'htmlall':'UTF-8'}" id="dpdfrance_predict_gsm_button_opc"></input>{/if}{if $dpdfrance_predict_status == 'ok'}<input type="submit" value="{$dpdfrance_predict_gsm_dest|escape:'htmlall':'UTF-8'}" id="dpdfrance_predict_gsm_button_opc_ok"></input>{/if}
			</p>
		</form>
	</div>
</div>