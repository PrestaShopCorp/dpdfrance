		...
		$('#open_pasclient').fancybox({
			...
			beforeShow: function() {
				$("#contact_form").validate({
					...
					messages: {
						raison_sociale: " {/literal}{l s='Please enter your' mod='dpdfrance'} {l s='Company Name' mod='dpdfrance'}{literal}",
						adresse: " {/literal}{l s='Please enter your' mod='dpdfrance'} {l s='Address' mod='dpdfrance'}{literal}",
						code_postal: {
						...
						ville: " {/literal}{l s='Please enter your' mod='dpdfrance'} {l s='City' mod='dpdfrance'}{literal}",
						telephone: {
...
{/literal}
 ...
 <div id="dpdfrance_contact_form" style="display: none;">
	<div style="text-align: left; margin:0; padding: 0">
		<img src="../modules/dpdfrance/logo.png" /> <h2 style="display: inline; vertical-align: middle; margin-left: 6px;">{l s='Get in touch with us!' mod='dpdfrance'}</h2>
	</div>

	<hr style="display: block; border-bottom: 1px solid #DDD;">

	<p style="margin-top: 20px; text-align: justify;">{l s='By choosing DPD, you will enjoy innovative delivery solutions: home appointment with our Predict service, to more than 5.000 Pickup relaypoints with DPD Relais, on workplace with DPD Classic and worldwide with the DPD Classic Intercontinental services.' mod='dpdfrance'}</p>
	<p style="margin-top: 20px; text-align: justify;">{l s='Before starting our partnership, it is necessary to sign a contract with one of our sales representatives who will guide you and meet your expectations (parcel picking schedules, pricing conditions, number of shipments, labeling solution, packaging supplies...)' mod='dpdfrance'}</p>
	<p style="margin-top: 20px; text-align: justify;">{l s='Thank you in advance for completing this form so a sales representative can contact you as soon as possible.' mod='dpdfrance'}</p>

	<form id="contact_form" action="" method="post" style="margin-top: 20px; text-align: center">
		<dl style="text-align: left">
			<label for="raison_sociale" class="margin_contactform">{l s='Company Name' mod='dpdfrance'} : </label>
			<input type="text" value="" name="raison_sociale" id="raison_sociale" class="input_contactform"/><br/>			

			<label for="adresse" class="margin_contactform">{l s='Address' mod='dpdfrance'} : </label>
			<input type="text" value="" name="adresse" id="adresse" class="input_contactform"/> <br/>

			<label for="code_postal" class="margin_contactform">{l s='Postal code' mod='dpdfrance'} : </label>
			<input type="text" value="" name="code_postal" id="code_postal" class="input_contactform"/> <br/>

			<label for="ville" class="margin_contactform">{l s='City' mod='dpdfrance'} : </label>
			...
			<label for="message" class="margin_contactform">{l s='Your message' mod='dpdfrance'} : </label>
...
<form action="{$form_submit_url|escape:'htmlall':'UTF-8'}" method="post">
	<fieldset><legend><img src="../modules/dpdfrance/views/img/admin/admin.png" alt="" title="" />{l s='Settings' mod='dpdfrance'}</legend>
		...
		<div id="accueil" style="display:block;">
			...
			<div id="accueil_subtitle">{l s='Please configure the DPD module. Documentation is available here : ' mod='dpdfrance'}<a target="_blank" href="../modules/dpdfrance/docs/readme_dpdfrance_prestashop.pdf"><img src ="../modules/dpdfrance/views/img/admin/pdf.png" alt="PDF"/></a></div><br/>
			<div id="accueil_wrap">
				...
				<div id="client" href="javascript:void(0)" onclick="$(&quot;#accueil,#modes_transport,#options_supp,#gestion_exp&quot;).fadeOut(0, function() {literal}{{/literal}$(&quot;#donnees_exp&quot;).fadeIn(&quot;slow&quot;){literal}}{/literal});"><span class="client_title">{l s='I\'m already a customer' mod='dpdfrance'}</span><div id="client_img"></div><span class="client_subtitle">{l s='Proceed to the plugin configuration' mod='dpdfrance'}</span></div>
				<br/>
			</div>
		</div>
